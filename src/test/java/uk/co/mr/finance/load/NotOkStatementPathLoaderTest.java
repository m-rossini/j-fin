...
public class NotOkStatementPathLoaderTest {
  private static final Logger LOG = LoggerFactory.getLogger(NotOkStatementPathLoaderTest.class);
  ...
  private Tuple2<Optional<Throwable>, Optional<StatementSummary>> loadData(Path path) {
    StatementPathLoader loader = new StatementPathLoader(connection.getOrElseThrow(() -> new RuntimeException("Should have a connection")),
